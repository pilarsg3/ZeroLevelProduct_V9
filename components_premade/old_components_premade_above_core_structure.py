...
if __name__ == "__main__":
    ...
    assy1 = create_above_core_structure(
    ...
    assy2 = create_above_core_structure(
    top_cyl_outer_r      = 1.843,
    top_cyl_height       = 1.008,

    neck_outer_r         = 1.1085,
    neck_height          = 0.569,   # neck band height

    collar_outer_r       = 1.300,   # > neck_outer_r  -> collar now protrudes
    collar_height        = 0.250,   # collar band height (distinct from neck)
